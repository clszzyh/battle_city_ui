defmodule BattleCityWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("battle_city.repo.query.total_time", unit: {:native, :millisecond}),
      summary("battle_city.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("battle_city.repo.query.query_time", unit: {:native, :millisecond}),
      summary("battle_city.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("battle_city.repo.query.idle_time", unit: {:native, :millisecond}),
