defmodule BattleCityUiWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("battle_city_ui.repo.query.total_time", unit: {:native, :millisecond}),
      summary("battle_city_ui.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("battle_city_ui.repo.query.query_time", unit: {:native, :millisecond}),
      summary("battle_city_ui.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("battle_city_ui.repo.query.idle_time", unit: {:native, :millisecond}),
      ...
      summary("battle_city.game_loop.stop.duration", unit: {:native, :millisecond})
    ]
  end
